...
CREATE TABLE `ticket_details` (
  `tic_no` int(5) NOT NULL,
  `source` varchar(20) DEFAULT 'yeshwantpur',
  `destination` varchar(20) NOT NULL DEFAULT 'nsr',
  `fare` float DEFAULT NULL,
  `class_id` varchar(5) DEFAULT '16250',
  PRIMARY KEY (`tic_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;



--Dumping data into table ticket_details
INSERT INTO `ticket_details` (`tic_no`, `source`, `destination`, `fare`, `class_id`) VALUES
(10, 'mumbai', 'chennai', '300', 'EC'),
(12, 'chennai', 'bengaluru', '350', '1AC');


--Table structure for table 'book_a_ticket'
CREATE TABLE `book_a_ticket` (
...
--dUMOING VALUES INTO TABLE BOOK A TICKET
INSERT INTO `book_a_ticket` (`Source`, `Destination`, `No_of_seats`, `Class_type`, `login_password`, `date`) VALUES ('Bengaluru', 'Mysore', '4', 'EC', '123123123', '2023-01-12');
